...
const generateId = () => Math.random().toString(16).substring(2, 9);
//Polleras
...
//Lista de productos
export {producto1,producto2,producto3,producto4,producto5,producto6,producto7,producto8,producto9,producto10}
